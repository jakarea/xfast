			...
			<div class="row">
				...
				<div class="col-md-9 page-content">
					...
					<div class="inner-box default-inner-box" style="overflow: visible;">
                        ...
                        <div class="inner-box">
                            <h2 class="title-2">
                                <strong><i class="fa-solid fa-user-plus"></i>  {{ t('Add Staff') }}</strong>
                            </h2>
                                    ...
                                    <form id="signupForm" class="form-horizontal" method="POST" action="{{ url()->current() }}">
                                        ...
                                        <fieldset> 
                                            ...
                                            <div class="row mb-3 required">
                                                <label class="col-md-3 col-form-label" for="name">{{ t('Name') }}</label>
                                            ...
                                            <div class="row mb-3 auth-field-item required{{ $forceToDisplay }}">
                                                <label class="col-md-3 col-form-label pt-0" for="email">
                                                    {{--{{ t('email') }}--}}
                                                    Email or Phone
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label"></label>
                                                <div class="col-md-7">
                                                    <button id="signupBtn" class="btn btn-primary btn-lg"> {{ t('Add') }} </button>
                                                </div>
                                            </div>
