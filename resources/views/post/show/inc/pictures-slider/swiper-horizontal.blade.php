...
<div class="gallery-container">
		...
		<div class="swiper-wrapper">
			@forelse($pictures as $key => $image)
				<div class="swiper-slide">
					{!! imgTag(data_get($image, 'filename'), 'picture-lg', ['alt' => $titleSlug . '-big-' . $key]) !!}
				</div>
			@empty
				<div class="swiper-slide">
					<img src="{{ imgUrl(config('larapen.media.picture'), 'picture-lg') }}" alt="img" class="default-picture">
				</div>
			@endforelse
		</div>
	...
	<div class="swiper thumbs-gallery">
		<div class="swiper-wrapper">
			@forelse($pictures as $key => $image)
				<div class="swiper-slide">
					{!! imgTag(data_get($image, 'filename'), 'picture-sm', ['alt' => $titleSlug . '-small-' . $key]) !!}
				</div>
			@empty
				<div class="swiper-slide">
					<img src="{{ imgUrl(config('larapen.media.picture'), 'picture-sm') }}" alt="img" class="default-picture">
				</div>
			@endforelse
		</div>
	</div>
