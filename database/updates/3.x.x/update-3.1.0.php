...
try {
	...
	if (Schema::hasTable('posts')) {
		...
		DBTool::dropIndexIfExists('posts', 'seller_name');
		...
		DBTool::dropIndexIfExists('posts', 'contact_name');
		DBTool::createIndexIfNotExists('posts', 'contact_name');
	...
	$allData = [
		[
			...
			'method'    => 'getLocations',
			'options'   => '{"max_items":"14","show_map":"1","map_background_color":null,"map_border":null,"map_hover_border":null,"map_border_width":null,"map_color":null,"map_hover":null,"map_width":"300px","map_height":"300px","cache_expiration":null}',
