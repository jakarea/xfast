...
try {
	...
	// .ENV
	if (DotenvEditor::keyExists('APP_FALLBACK_LOCALE')) {
		DotenvEditor::deleteKey('APP_FALLBACK_LOCALE');
	}
	if (DotenvEditor::keyExists('APP_LOG_LEVEL')) {
		DotenvEditor::deleteKey('APP_LOG_LEVEL');
	}
	if (DotenvEditor::keyExists('APP_LOG')) {
		DotenvEditor::deleteKey('APP_LOG');
	}
	if (DotenvEditor::keyExists('APP_LOG_MAX_FILES')) {
		DotenvEditor::deleteKey('APP_LOG_MAX_FILES');
	}
	if (DotenvEditor::keyExists('MULTI_COUNTRY_SEO_LINKS')) {
