...
class PostRequest extends Request
{
	...
	protected function prepareForValidation()
	{
		...
		if ($this->filled('title')) {
			...
			$input['title'] = prevent_str_containing_only_numeric_chars($input['title']);
		...
		if ($this->filled('description')) {
			...
			$input['description'] = prevent_str_containing_only_numeric_chars($input['description']);
		...
		if ($this->filled('contact_name')) {
			...
			$input['contact_name'] = prevent_str_containing_only_numeric_chars($input['contact_name']);
		}
