...
class MessagesController extends AccountBaseController
{
	...
	public function __construct()
	{
		...
		$this->perPage = (is_numeric(config('settings.pagination.per_page'))) ? config('settings.pagination.per_page') : $this->perPage;
	}
	...
	public function actions($threadId = null)
	{
		...
		$actionType = in_array(request()->method(), ['POST', 'PUT'])
			? request()->input('type')
			: request()->query('type');
