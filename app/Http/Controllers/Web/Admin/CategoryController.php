...
class CategoryController extends PanelController
{
	...
	private function uploadFile($request)
	{
        ...
        /**for mobile images*/
        $attributeMobile = 'mobile_picture';
        $destPathMobile = 'app/categories/custom';
        $fileMobile = $request->hasFile($attributeMobile) ? $request->file($attributeMobile) : $request->input($attributeMobile);

        $request->request->set($attributeMobile, Upload::image($destPathMobile, $fileMobile, 'cat'));
