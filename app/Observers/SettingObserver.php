...
{
	use AppTrait, CurrencyexchangeTrait, DomainmappingTrait, ListTrait, LocalizationTrait, MailTrait, OptimizationTrait;
	use SecurityTrait, SeoTrait, SingleTrait, SmsTrait, SocialShareTrait, StyleTrait;
